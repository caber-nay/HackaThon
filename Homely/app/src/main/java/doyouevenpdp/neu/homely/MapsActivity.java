...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mealButton = findViewById(R.id.button_meal);
        shelterButton = findViewById(R.id.button_shelters);
        ...
        mealButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    JSONArray jsonArray = jsonObject.getJSONArray("foodLocation");
                    for (int i=0 ; i<jsonArray.length() ; ++i) {
                        ...
                        String name = jsonObject1.getString("name_of_program");
        ...
        shelterButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getBaseContext(),"Currently Unavailable",Toast.LENGTH_LONG).show();
            }
        });
